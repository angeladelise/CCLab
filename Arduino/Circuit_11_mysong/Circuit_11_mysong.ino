...
char notes[] = "cffgagada dfagagadada cffdfdgagada aadgfadada  ddfagacfdgagada cfagadgfadada"; // a space represents a rest

// Beats is an array of values for each note and rest.
// A "1" represents a quarter-note, 2 a half-note, etc.
// Don't forget that the rests (spaces) need a length as well.

int beats[] = {1,1,2,2,4,1,4,4,2,1,1,3,4,1,1,2,3,2};
...
int frequency(char note) 
{
  ...
  int frequencies[] = {232, 234, 330, 239, 322, 340, 454, 523};
